 ...
 public:
  class StubInterface {
   public:
    ...
    std::unique_ptr< ::grpc::ClientWriterInterface< ::tafs::WriteReq>> WriteS(::grpc::ClientContext* context, ::tafs::WriteReply* response) {
      return std::unique_ptr< ::grpc::ClientWriterInterface< ::tafs::WriteReq>>(WriteSRaw(context, response));
    }
    std::unique_ptr< ::grpc::ClientAsyncWriterInterface< ::tafs::WriteReq>> AsyncWriteS(::grpc::ClientContext* context, ::tafs::WriteReply* response, ::grpc::CompletionQueue* cq, void* tag) {
      return std::unique_ptr< ::grpc::ClientAsyncWriterInterface< ::tafs::WriteReq>>(AsyncWriteSRaw(context, response, cq, tag));
    }
  ...
  private:
    ...
    virtual ::grpc::ClientWriterInterface< ::tafs::WriteReq>* WriteSRaw(::grpc::ClientContext* context, ::tafs::WriteReply* response) = 0;
    virtual ::grpc::ClientAsyncWriterInterface< ::tafs::WriteReq>* AsyncWriteSRaw(::grpc::ClientContext* context, ::tafs::WriteReply* response, ::grpc::CompletionQueue* cq, void* tag) = 0;
  ...
  class Stub GRPC_FINAL : public StubInterface {
   public:
    ...
    std::unique_ptr< ::grpc::ClientWriter< ::tafs::WriteReq>> WriteS(::grpc::ClientContext* context, ::tafs::WriteReply* response) {
      return std::unique_ptr< ::grpc::ClientWriter< ::tafs::WriteReq>>(WriteSRaw(context, response));
    }
    std::unique_ptr< ::grpc::ClientAsyncWriter< ::tafs::WriteReq>> AsyncWriteS(::grpc::ClientContext* context, ::tafs::WriteReply* response, ::grpc::CompletionQueue* cq, void* tag) {
      return std::unique_ptr< ::grpc::ClientAsyncWriter< ::tafs::WriteReq>>(AsyncWriteSRaw(context, response, cq, tag));
    }
   ...
   private:
    ...
    ::grpc::ClientWriter< ::tafs::WriteReq>* WriteSRaw(::grpc::ClientContext* context, ::tafs::WriteReply* response) GRPC_OVERRIDE;
    ::grpc::ClientAsyncWriter< ::tafs::WriteReq>* AsyncWriteSRaw(::grpc::ClientContext* context, ::tafs::WriteReply* response, ::grpc::CompletionQueue* cq, void* tag) GRPC_OVERRIDE;
  ...
  class Service : public ::grpc::SynchronousService {
   public:
    ...
    virtual ::grpc::Status WriteS(::grpc::ServerContext* context, ::grpc::ServerReader< ::tafs::WriteReq>* reader, ::tafs::WriteReply* response);
  ...
  class AsyncService GRPC_FINAL : public ::grpc::AsynchronousService {
   public:
    ...
    void RequestWriteS(::grpc::ServerContext* context, ::grpc::ServerAsyncReader< ::tafs::WriteReply, ::tafs::WriteReq>* reader, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag);
